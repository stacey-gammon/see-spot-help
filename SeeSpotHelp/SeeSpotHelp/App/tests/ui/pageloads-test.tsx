...
//     AnimalHomePage['childContextTypes'] = { router: [] } as any;
//     GroupHomePage['childContextTypes'] = { router: [] } as any;
//     EditProfile['childContextTypes'] = { router: [] } as any;
//     ProfilePage['childContextTypes'] = { router: [] } as any;
//     AddAnimalNote['childContextTypes'] = { router: [] } as any;
//     AddAnimalPage['childContextTypes'] = { router: [] } as any;
//     SignUpPage['childContextTypes'] = { router: [] } as any;
//     AddPhotoPage['childContextTypes'] = { router: [] } as any;
//     SearchPage['childContextTypes'] = { router: [] } as any;
//     MemberPage['childContextTypes'] = { router: [] } as any;
//     LoginPage['childContextTypes'] = { router: [] } as any;
//     PrivateBetaPage['childContextTypes'] = { router: [] } as any;
//     EnterBetaCode['childContextTypes'] = { router: [] } as any;
//     AddCalendarEvent['childContextTypes'] = { router: [] } as any;
//
